class Tooltip {
  ...
  showTooltip() {
    ...
    this.tooltip.classList.remove('c-tooltip--hidden')
  }

  hideTooltip() {
    this.container.classList.remove('c-tooltip--visible')
    this.tooltip.classList.add('c-tooltip--hidden')
  }
...
Array.from(document.querySelectorAll('.c-tooltip__container')).forEach(element => new Tooltip(element))
