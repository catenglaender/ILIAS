...
interface Factory
{
     ...
     * description:
     *   purpose: >
     *     Inline Lists are used to display set of elements next to each other when
     *     the available space allows for it. The elements belong to a group of similar items and
     *     have about equal relevance.
     *   composition: >
     *     Inline Lists string up the items horizontally breaking into the next line if necessary.
     *     They are separated by a comma.
     *   rivals:
     *      Unordered & Ordered Listings: >
     *          If there is enough space for a vertical list, unordered and ordered listings should
     ...
     *          - You MUST NOT use this component as a layout tool to force unrelated components next to
     *              each other.
     ...
     * ----
     * @param array<string, Component\Component>  $items Set of elements to be rendered (string | Component)[]
     ...
     *          unexpected ways.
     *      - With 6+ properties, you SHOULD use multiple Property Components
     ...
     *   accessibility:
     *      - When using a Symbol, you still MUST enter a label or value
     *          string with a text that can be understood when read through
     *          a screen reader independently of any visuals. This string
     *          is passed onto the Symbol as the aria-label.
     * context:
