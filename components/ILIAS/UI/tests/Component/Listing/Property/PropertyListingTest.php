...
<div class="l-bar__space-keeper c-listing-property"><div class="l-bar__group c-listing-property__property"><span class="l-bar__element c-listing-property__propertylabel">label1</span><span class="l-bar__element c-listing-property__propertyvalue t-text-more-less"><span class="t-text-more-less__text-body">value1</span></span></div><div class="l-bar__group c-listing-property__property"><span class="l-bar__element c-listing-property__propertyvalue t-text-more-less"><span class="t-text-more-less__text-body">value2</span></span></div></div>
        ');
    ...
    public function testPropertyListingSymbolsRendering(): void
    {
        ...
        $expected = $this->brutallyTrimHTML('
            <div class="l-bar__space-keeper c-listing-property"><div class="l-bar__group c-listing-property__property"><span class="l-bar__element c-listing-property__propertylabel"><a class="glyph" aria-label="show_who_is_online"><span class="glyphicon glyphicon-user" aria-hidden="true"></span></a></span><span class="l-bar__element c-listing-property__propertyvalue t-text-more-less"><span class="t-text-more-less__text-body">value1</span></span></div><div class="l-bar__group c-listing-property__property"><span class="l-bar__element c-listing-property__propertylabel">label2</span><span class="l-bar__element c-listing-property__propertyvalue t-text-more-less"><span class="t-text-more-less__text-body"><a class="glyph" aria-label="show_who_is_online"><span class="glyphicon glyphicon-user" aria-hidden="true"></span></a></span></span></div></div>
        ');
